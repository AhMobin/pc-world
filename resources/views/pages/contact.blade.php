                ...
                <div class="col-xs-12">
                    <div class="bradcaump__inner">
                        <nav class="bradcaump-inner">
                            <h2 style="color: #f2dede; text-align: left; font-weight: bold">Contact US</h2>
                        </nav>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                <h2 class="title__line--6" style="color: #f2dede">CONTACT INFORMATION</h2>
                <div class="address">
                    ...
                    <div class="address__details">
                        ...
                        <p>Road No - 5, Dhanmondi, Dhaka - 1205 </p>
                    </div>
                </div>
                <div class="address">
                    <div class="address__icon">
                    ...
                    <div class="address__details">
                        <h2 class="ct__title">We are available </h2>
                        <p>10 AM - 8 PM </p>
                    </div>
                </div>
            ...
            <div class="contact-form-wrap mt--60">
                <div class="col-xs-12">
                    <div class="contact-title">
                        <h2 class="title__line--6" style="color: #f2dede">SEND A MAIL</h2>
                    </div>
                </div>
                <div class="col-xs-12">
...
<script>
    ...
    function init() {
        ...
        var mapOptions = {
            ...
            center: new google.maps.LatLng(23.746466, 90.376015), // New York
