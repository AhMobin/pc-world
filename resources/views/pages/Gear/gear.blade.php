...
@section('content')
    ...
    @php
        ...
        ->where('category_id',3)->where('status',1)->orderBy('id','DESC')->get();
    @endphp
                                        ...
                                        <div class="ht__cat__thumb">
                                            <ul style="text-align: center">
                                                <li style="text-align: center">
                                                    <a href="{{ url('product/details/'.$pr->product_slug) }}"><img src="{{ URL::to($pr->product_image_one) }}" alt="" height="150px" width="180px"></a>
                                                </li>
                                        ...
                                        <div class="slider__range--output">
                                            <div class="price__output--wrap">
                                                <div class="price--output">
                                                    <span style="color:gray;">Price :</span><input type="text" id="amount" readonly style="background-color: #1e1e24; color: white">
                                                </div>
