...
@section('content')
    ...
    <div class="ht__bradcaump__area" style="background: url('{{ asset("public/frontend/images/slider/bg/slider-1.jpg") }}') no-repeat center center / cover ; height: 50vh">
            ...
            <div style="max-width: 850px; margin: auto">
                <div class="developer">
                    <div style="max-width: 200px; float: left;">
                        <img src="{{ asset('public/frontend/images/about/mehedi.JPG') }}" alt="" style="border-radius: 50%">
                    </div>
