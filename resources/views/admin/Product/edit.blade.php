                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_slug"  value="{{ $product->product_slug }}">
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_model" value="{{ $product->product_model }}" >
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="discount_prize" value="{{ $product->discount_prize }}" >
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="selling_prize"  placeholder="Selling Price" value="{{ $product->selling_prize }}">
                                </div>
                            </div><!-- col-4 -->
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <label class="custom-file">
                                ...
                                <input type="hidden" name="old_one" value="{{ $product->product_image_one }}">
                                <img src="#" id="one" >
                            </label>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <img src="{{ URL::to($product->product_image_one) }}" style="height: 80px; width: 80px;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <label class="custom-file">
                                ...
                                <input type="hidden" name="old_two" value="{{ $product->product_image_two }}">
                                <span class="custom-file-control"></span>
                                <img src="#" id="two" >
                            </label>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <img src="{{ URL::to($product->product_image_two) }}" style="height: 80px; width: 80px;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <label class="custom-file">
                                ...
                                <span class="custom-file-control"></span>
                                <img src="#" id="three" >
                                <input type="hidden" name="old_three" value="{{ $product->product_image_three }}">
                            </label>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <img src="{{ URL::to($product->product_image_three) }}" style="height: 80px; width: 80px;">
                        </div>
