...
{{--            <a class="breadcrumb-item" href="#">Starlight</a>--}}
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                            ...
                            <table  class="table display responsive nowrap">
                                ...
                                @foreach($details as $row)
                                    <tr>
                                        ...
                                        <td><img src="{{ URL::to($row->product_image_one) }}" height="50px;" width="50px;"></td>
                                        <td>{{ $row->color }}</td>
                                        <td>{{ $row->size }}</td>
                                        <td>{{ $row->quantity }}</td>
                                        <td>
                ...
                @elseif($order->status == 1)
                    <a href="{{ url('product/delivery/progress/'.$order->id) }}" class="btn btn-info">Run To Progress</a>
                    <strong> Payment Already Checked and pass here for delevery request</strong>
                @elseif($order->status == 2)
                    <a href="{{ url('admin/delivery/done/'.$order->id) }}" class="btn btn-success">Delivered Done</a>
                ...
                @else
                    <strong class="text-danger">Order Canceled</strong>
                @endif
