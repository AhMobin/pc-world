    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title mb-3">Brands List
                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        @foreach($brand as $row)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ URL::to($row->brand_logo) }}" alt="" height="60">
                                </td>
                                <td>
                                    <a href="{{ URL::to('brand/edit/'.$row->id) }}" class="btn btn-sm btn-info">Edit</a>
                                    <a href="{{ URL::to('brand/delete/'.$row->id) }}" id="delete" class="btn btn-sm btn-danger">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
