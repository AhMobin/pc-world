...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2020 at 04:11 PM
...
--
-- Table structure for table `featured_reviews`
--

CREATE TABLE `featured_reviews` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `feature_title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `feature_review` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `feature_btn` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `feature_btn_link` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `featured_reviews`
--

INSERT INTO `featured_reviews` (`id`, `feature_title`, `feature_review`, `feature_btn`, `feature_btn_link`, `feature_image`, `status`, `created_at`, `updated_at`) VALUES
(2, 'Lorem ipsum dolor sit amet.', 'Lorem ipsum dolor sit amet, consectetur adipisici elit, sed do eiusmod tempor incididunt ut', 'Shop Now', 'http://localhost/laravel_app/pc-world/workstation', 'public/frontend/images/reviews/180120_13_25_44.png', 1, NULL, NULL);
...
CREATE TABLE `focuses` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `focus_title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `focus_desc` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `focus_image` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int(11) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `focuses` (`id`, `focus_title`, `focus_desc`, `focus_image`, `status`, `created_at`, `updated_at`) VALUES
(2, 'Craftsmanship', 'Lorem ipsum dolor sit amet, consectetur adipisici elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis culpa nam, provident quasi ratione voluptatibus. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, pariatur.', 'public/backend/media/settings/focus/focus-5e2309610ad4d.jpg', 0, NULL, NULL);
...
CREATE TABLE `logos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branding_logo` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int(11) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `logos` (`id`, `branding_logo`, `status`, `created_at`, `updated_at`) VALUES
(1, 'public/backend/media/settings/logos/060120_18_36_44.png', 0, NULL, NULL),
(5, 'public/backend/media/settings/logos/1655007645079945.png', 1, NULL, NULL);
...
(17, '2020_01_06_182637_create_logos_tables', 10),
(18, '2020_01_07_082914_create_sliders_table', 11),
(19, '2020_01_16_114417_create_focuses_table', 12),
(20, '2020_01_16_203005_create_featured_reviews_table', 13),
(21, '2020_01_18_093407_create_our_recommendations_table', 14);
...
--
-- Table structure for table `our_recommendations`
--

CREATE TABLE `our_recommendations` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `recom_title` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cpu` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `motherboard` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ram` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `gpu` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `storage` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `recom_image` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `our_recommendations`
--

INSERT INTO `our_recommendations` (`id`, `recom_title`, `cpu`, `motherboard`, `ram`, `gpu`, `storage`, `recom_image`, `price`, `status`, `created_at`, `updated_at`) VALUES
(2, 'Premium Recommendation', 'Intel Core i7', 'Gygabyte DDR4', 'Intel 16GB', 'Gygabyte 4GB', 'Toshiba 1TB', 'public/backend/media/recommendations/recom-5e22e571069aa.jpg', '56000', 1, NULL, NULL);
...
CREATE TABLE `sliders` (
  ...
  `slider_subdesc` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slider_btn` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slider_btn_link` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `sliders` (`id`, `slider_title`, `slider_description`, `slider_subdesc`, `slider_btn`, `slider_btn_link`, `slider_image`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Play Now, Play Later', 'lorem ipsume doller miscy iteama lorem ipsume doller miscy iteama lorem ipsume doller miscy iteama', 'Perchase Select System And Get', 'Build Now', 'http://localhost/laravel_app/pc-world/configure/custom/desktop', 'public/frontend/images/slider/070120_11_39_14.jpg', '1', NULL, NULL),
(3, 'WELL DESIGNED, EXTREME, AND INTIMIDATING', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam aliquid aperiam cum dolor doloribus, eius est incidunt, laboriosam maxime modi mollitia, possimus quasi quidem reiciendis repellendus tempore tenetur voluptatem. A?', 'Easy Pre-Approved Online Financing Available', 'Build Now', 'http://localhost/laravel_app/pc-world/configure/custom/desktop', 'public/frontend/images/slider/070120_11_51_24.jpg', '1', NULL, NULL);
...
(22, 1, 'Workstation Desktop', 'workstation-desktop', '2020-01-16 08:59:51', '2020-01-16 08:59:51');
...
(1, 'First User', '01234567891', 'user1@mail.com', NULL, '$2y$10$zAzNhiJnh6ymOX2oiwAZtuxqHHQI47akRPS96AYxMhznKTsv7htYa', 'public/frontend/images/users/1654918650621943.png', NULL, '2019-12-05 07:42:20', '2019-12-05 07:42:20'),
(2, 'Second User', '01234567892', 'user2@mail.com', NULL, '$2y$10$XwnfbGqn89ATGgUAsD6dHOuwFQ12jBDcNXVew9B7qv4165rn/FOlC', 'public/frontend/images/users/1654918771566518.png', NULL, '2019-12-06 07:39:25', '2019-12-06 07:39:25'),
(3, 'Third User', '01234567893', 'user3@gmail.com', NULL, '$2y$10$TgPJZ/wx64OlKu4iL6.CJu1lagoVeyf/qWVfish1JIn2yLoANYUkW', 'public/frontend/images/users/1654918808820690.png', 'PvIBuLjyL0iSmIcMUjpO0aQ98itoTcZIy7t5LglM7hutpH260MjuAqixFUS5', '2019-12-06 07:52:09', '2019-12-06 07:52:09'),
(4, 'Another User', '1234569874', 'user4@mail.com', NULL, '$2y$10$9eFkx2wAmQz5rGBEUlKZGunL3pW38sYZIh58nxKVdhcY/5Nyjquc2', 'public/frontend/images/users/1654905660259532.png', NULL, '2019-12-17 08:46:02', '2019-12-17 08:46:02');
...
--
-- Indexes for table `featured_reviews`
--
ALTER TABLE `featured_reviews`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `our_recommendations`
--
ALTER TABLE `our_recommendations`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `featured_reviews`
--
ALTER TABLE `featured_reviews`
...
--
-- AUTO_INCREMENT for table `our_recommendations`
--
ALTER TABLE `our_recommendations`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
